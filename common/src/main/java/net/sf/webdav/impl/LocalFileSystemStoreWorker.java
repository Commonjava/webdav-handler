...
@Alternative
@Named
public class LocalFileSystemStoreWorker
    implements IWebdavStoreWorker
{

    private static org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger( LocalFileSystemStoreWorker.class );

    private static int BUF_SIZE = 65536;

    private File _root = null;

    public LocalFileSystemStoreWorker( final File root )
    {
        _root = root;
    }
